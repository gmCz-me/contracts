...
contract GMCZ is Context, IERC20, Ownable {
    ...
    string private _name = "gmCZ.me";
    string private _symbol = "GMCZ";
    ...
    uint256 public _czPercent = 25;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address payable public _charityWalletAddress;
    address payable public _czWalletAddress;
    ...
    constructor (address payable charityWalletAddress, address payable czWalletAddress) public {
        _charityWalletAddress = charityWalletAddress;
        _czWalletAddress = czWalletAddress;
        ...
        _isExcludedFromFee[czWalletAddress] = true;
    ...
    function setCzPercent(uint256 czPercent) external onlyOwner() {
        _czPercent = czPercent;
    }
    ...
    function sendBNBToCharity(uint256 amount) private {
        uint256 czAmount = amount.mul(_czPercent).div(100);
        swapTokensForEth(amount.sub(czAmount));
        uint256 balanceAmount = address(this).balance;
        _charityWalletAddress.transfer(balanceAmount);
        uint256 contractTokenBalance = balanceOf(address(this));
        _tokenTransfer(address(this), _czWalletAddress, czAmount > contractTokenBalance ? contractTokenBalance : czAmount, false);
    }
    ...
    function _setCzWallet(address payable czWalletAddress) external onlyOwner() {
        _czWalletAddress = czWalletAddress;
    }
